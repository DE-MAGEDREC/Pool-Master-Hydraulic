...
function resetAll() {
  ...
  $('#L').val(DEFAULT_VALUES.L);
  $('#l').val(DEFAULT_VALUES.l);
  $('#p').val(DEFAULT_VALUES.p);
  $('#cote').val(DEFAULT_VALUES.cote);
  $('#p_carre').val(DEFAULT_VALUES.p_carre);
  $('#D_piscine').val(DEFAULT_VALUES.D_piscine);
  $('#p_r').val(DEFAULT_VALUES.p_r);
  $('#a_ovale').val(DEFAULT_VALUES.a_ovale);
  $('#b_ovale').val(DEFAULT_VALUES.b_ovale);
  $('#p_o').val(DEFAULT_VALUES.p_o);
  $('#L_libre').val(DEFAULT_VALUES.L_libre);
  $('#l_libre').val(DEFAULT_VALUES.l_libre);
  $('#p_libre').val(DEFAULT_VALUES.p_libre);
  $('#t_recycl').val(DEFAULT_VALUES.t_recycl);
  $('#D').val(DEFAULT_VALUES.D);
  $('#materiau').val(DEFAULT_VALUES.materiau);
  $('#L_asp').val(DEFAULT_VALUES.L_asp);
  $('#v_asp').val(DEFAULT_VALUES.v_asp);
  $('#L_ref').val(DEFAULT_VALUES.L_ref);
  $('#v_ref').val(DEFAULT_VALUES.v_ref);
  $('#coudes90C_asp').val(DEFAULT_VALUES.coudes90C_asp);
  $('#coudes90G_asp').val(DEFAULT_VALUES.coudes90G_asp);
  $('#coudes45_asp').val(DEFAULT_VALUES.coudes45_asp);
  $('#tes_asp').val(DEFAULT_VALUES.tes_asp);
  $('#vannes_asp').val(DEFAULT_VALUES.vannes_asp);
  $('#coudes90C_ref').val(DEFAULT_VALUES.coudes90C_ref);
  $('#coudes90G_ref').val(DEFAULT_VALUES.coudes90G_ref);
  $('#coudes45_ref').val(DEFAULT_VALUES.coudes45_ref);
  $('#tes_ref').val(DEFAULT_VALUES.tes_ref);
  $('#vannes_ref').val(DEFAULT_VALUES.vannes_ref);
  $('#H_geo').val(DEFAULT_VALUES.H_geo);
  $('#dp_filtre').val(DEFAULT_VALUES.dp_filtre);
...
$(document).ready(function() {
  ...
  $('.forme-radio').on('change', function() { choixForme(); });

  // Événements sur tous les inputs et selects
  $('input, select').on('input change', function() { calculerResultats(); });

  // Bouton reset
  $('#btn-reset').on('click', function() { resetAll(); });

  // Bouton rapport
  $('#btn-rapport').on('click', function() { ouvrirRapport(); });
