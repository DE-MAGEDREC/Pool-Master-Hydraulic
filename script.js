...
var translations = {
  fr: {
    ...
    mention: "Les valeurs présentées sont indicatives et permettent une approche dimensionnelle. Ce document est à caractère indicatif. Les calculs sont basés sur des données standards et peuvent ne pas refléter les conditions réelles d'installation. Pour une étude approfondie, consultez un bureau d'études spécialisé.",
    imprimer: "🖨️ Imprimer",
    fermer: "✖ Fermer",
  ...
  en: {
    ...
    mention: "The values presented are indicative and allow a dimensional approach. This document is for informational purposes only. Calculations are based on standard data and may not reflect actual installation conditions. For a detailed study, please consult a specialized engineering firm.",
    imprimer: "🖨️ Print",
    fermer: "✖ Close",
  ...
  es: {
    ...
    mention: "Los valores presentados son indicativos y permiten un enfoque dimensional. Este documento tiene carácter indicativo. Los cálculos se basan en datos estándar y pueden no reflejar las condiciones reales de instalación. Para un estudio detallado, consulte una oficina de ingeniería especializada.",
    imprimer: "🖨️ Imprimir",
    fermer: "✖ Cerrar",
